          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                {...register('email')}
                disabled={loading}
                className="w-full px-3 sm:px-4 py-2 border border-zinc-300 dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#008B1C] dark:bg-zinc-800 dark:text-zinc-50 disabled:opacity-50 text-base"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-white font-medium py-2.5 sm:py-2 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-base touch-manipulation"
            >
